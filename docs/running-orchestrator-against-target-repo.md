...
ORCHESTRATOR_REPO_ROOT=/path/to/agent-dashboard
ORCHESTRATOR_MAX_EXECUTORS=3
ORCHESTRATOR_MAX_REVIEWERS=2
ORCHESTRATOR_POLL_INTERVAL_MS=15000
ORCHESTRATOR_STALL_MINUTES=120
ORCHESTRATOR_STATE_PATH=.orchestrator-state.json
ORCHESTRATOR_REVIEW_CHURN_POLLS=3
ORCHESTRATOR_REVIEWER_RETRY_POLLS=20
ORCHESTRATOR_MAX_REVIEWER_DISPATCHES_PER_STATUS=2
ORCHESTRATOR_ITEMS_FILE=/path/to/items.json
```
